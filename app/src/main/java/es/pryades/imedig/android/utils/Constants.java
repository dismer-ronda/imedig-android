...
public class Constants {
    ...
    public final static String ACTION_TRANSMIT = "hospital.linde.uk.apphubandroid.ACTION_TRANSMIT";
    public final static String TRANSMIT_DATA = "hospital.linde.uk.apphubandroid.TRANSMIT_DATA";
